...
$pdf->SetHeaderData($logo, 40, 'Stock Critico Bodega: '.$arrProductos[0]['NombreBodega'], 'Stock al '.fecha_actual());
...
$pdf->Output('Stock Critico Bodega '.$arrProductos[0]['NombreBodega'].' al '.fecha_actual().'.pdf', 'I');
