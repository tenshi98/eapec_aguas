...
$pdf->SetHeaderData($logo, 40, 'Movimientos Proveedor: '.$arrProductos[0]['Proveedor'], 'Registros entre fechas '.Fecha_estandar($_GET['f_inicio']).' al '.Fecha_estandar($_GET['f_termino']) );
...
$pdf->Output('Movimiento Proveedor '.$arrProductos[0]['Proveedor'].'.pdf', 'I');
