...
$pdf->SetHeaderData($logo, 40, 'Movimientos Bodega: '.$arrProductos[0]['NombreBodega'].' (ultimos 100 registros)', 'Producto: '.$arrProductos[0]['NombreProducto']);
...
$pdf->Output('Movimiento Producto '.$arrProductos[0]['NombreProducto'].' Bodega '.$arrProductos[0]['NombreBodega'].' ultimos 100 registros.pdf', 'I');
