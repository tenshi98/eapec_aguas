...
$pdf->SetHeaderData($logo, 40, 'Movimientos Bodega: '.$arrProductos[0]['NombreBodega'].', Registros entre fechas '.Fecha_estandar($_GET['f_inicio']).' al '.Fecha_estandar($_GET['f_termino']), 'Producto: '.$arrProductos[0]['NombreProducto']);
	...
	<tbody>';
		...
		foreach ($arrProductos as $productos) { 
			...
			$html .='<tr>
						...
						<td>'.Cantidades_decimales_justos($productos['Cantidad_ing']).' '.$productos['UnidadMedida'].'</td>
						<td>'.Cantidades_decimales_justos($productos['Cantidad_eg']).' '.$productos['UnidadMedida'].'</td>
						<td>'.Valores_sd($productos['Valor']).' x '.$productos['UnidadMedida'].'</td>
					</tr>';
		}
...
$pdf->Output('Valor Producto '.$arrProductos[0]['NombreProducto'].' Bodega '.$arrProductos[0]['NombreBodega'].'.pdf', 'I');
