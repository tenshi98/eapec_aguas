...
$pdf->SetHeaderData($logo, 40, 'Movimientos Bodega: '.$arrProductos[0]['NombreBodega'].', Registros de '.$arrProductos[0]['Mes'].' de '.$_GET['Creacion_ano'], 'Producto: '.$arrProductos[0]['NombreProducto']);
